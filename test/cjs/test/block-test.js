...
var doubles = require('./doubles.js');
var block = require('../src/workers/block.js');

let subject;
const test = helpers.testFactory(
  function setup () {
...
test('add calls `Bin#add`', (t) => {
  let count = 0;
  let binAdd = doubles.BinDouble.prototype.add;

  Object.defineProperty(subject, 'createBin', { value: () => new doubles.BinDouble });
  doubles.BinDouble.prototype.add = (samples) => {
